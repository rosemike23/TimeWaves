...
class Exp_Short_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting, args):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            #! added
            if vali_loss<Loss_list[2]:
                Loss_list[0] = epoch + 1
                Loss_list[1] = train_loss
                Loss_list[2] = vali_loss
                Loss_list[3] = test_loss
        ...
        #! added
        address = "result_short_term_forecast.txt.txt"
        f = open(address, 'a+')
        f.write( "\n")
        f.write(setting + "  \n")
        f.write(f"Loss:{args.loss},BatchSize:{args.batch_size},LearningRate:{args.learning_rate},top_k:{args.top_k}")
        f.close()
        
        #! added
        f = open(address, 'a+')
        f.write( "\n")
        f.write("Best at Epoch: {}, | Train Loss: {:.7f} Vali Loss: {:.7f} Test Loss: {:.7f}".format(
